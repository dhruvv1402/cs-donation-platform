...
// Extended project data with elegant colors
const projects = [
  {
  ...
  },
  {
    ...
    description:
      "An augmented reality tour guide app for university campuses with historical information and navigation.",
    student: "Sophia Chen",
  ...
  },
  {
    ...
    description:
      "A mobile app that provides mental health resources, mood tracking, and anonymous peer support for students.",
  ...
  },
  {
    ...
    description:
      "A platform for students to collaborate on coding projects in real-time with integrated code review tools.",
    student: "Raj Patel",
